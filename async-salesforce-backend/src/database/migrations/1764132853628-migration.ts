...
export class Migration1764132853628 implements MigrationInterface {
    name = 'Migration1764132853628'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "targets" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "created_by" uuid, "updated_by" uuid, "deleted_at" TIMESTAMP, "deleted_by" uuid, "project_id" uuid NOT NULL, "kind" character varying(50) NOT NULL, "name" character varying(255) NOT NULL, "connect_info" jsonb, "secrets_ref" character varying(255), "host" character varying(255), "port" integer, "database" character varying(255), "username" character varying(255), "schema" character varying(255), "ssl" boolean NOT NULL DEFAULT false, "ssl_mode" character varying(50), "connection_string" text, CONSTRAINT "PK_87084f49e9de9dd6a3e83906584" PRIMARY KEY ("id"))`);
